...
风物志入口独立放在顶部。设置内直接解释文化注解；正文注解是靠近词语的自制浮层，桌面鼠标悬停展开、移开自动合笺；键盘聚焦展开、失焦或 Escape 关闭。触屏轻点词语展开，再点任意位置（包括词语本身、浮层或酒馆外层）收起，无需寻找关闭按钮。
...
季节线稿在初次阅读及切换主题时短暂落笔，印章轻落；正文不逐段入场。设置、风物志、缘结小笺与御神签采用短促展开，注解轻柔显隐。无持续循环动画，遵循系统“减少动态效果”偏好，卸载界面时清理动画与监听。
